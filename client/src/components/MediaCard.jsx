          ...
          <Table size="small" aria-label="media throughput">
            ...
            <TableBody>
              <TableRow key="all">
                ...
                <TableCell align="right" style={{fontFamily: "courier", fontSize: 14, padding: "6px 0px"}}>{this.state.mediaThroughput.toFixed(0)}mL (~{this.state.rates.all.mediaRate.toFixed(1)}mL/h)</TableCell>
                <TableCell align="right" style={{fontFamily: "courier", fontSize: 14, padding: "6px 0px"}}>{this.state.altMediaThroughput.toFixed(0)}mL (~{this.state.rates.all.altMediaRate.toFixed(1)}mL/h)</TableCell>
              </TableRow>
              ...
              {this.state.activeUnits.map((unit) => (
                <TableRow key={unit}>
                  ...
                  <TableCell align="right" style={{fontFamily: "courier", fontSize: 14, padding: "6px 0px"}}>{(this.state.mediaThroughputPerUnit[unit] || 0).toFixed(0)}mL (~{this.state.rates[unit] ? this.state.rates[unit].mediaRate.toFixed(1) : "0.0"}mL/h)</TableCell>
                  <TableCell align="right" style={{fontFamily: "courier", fontSize: 14, padding: "6px 0px"}}>{(this.state.altMediaThroughputPerUnit[unit] || 0).toFixed(0)}mL (~{this.state.rates[unit] ? this.state.rates[unit].altMediaRate.toFixed(1): "0.0"}mL/h)</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
